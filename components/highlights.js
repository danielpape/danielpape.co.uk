    ...
    <div className="grid grid-cols-12 py-16 my-16 px-8 m-auto border-b border-slate-200">
      ...
      <div className="md:col-start-7 md:col-span-5 col-start-1 col-span-12 flex flex-col gap-8">
        <div className="flex flex-col gap-1 2xl:gap-2 pb-8">
          <h3 className="2xl:text-2xl font-serif text-slate-500">Next</h3>
          <p className="2xl:text-3xl text-xl text-slate-800 leading-relaxed">
            Saving over £2.5m per year for the UK’s leading retailer by
            redesigning the contact centre experience
          </p>
        </div>
        <div className="flex flex-col gap-1 2xl:gap-2 pb-8">
          <h3 className="2xl:text-2xl font-serif text-slate-500">
            The Independent
          </h3>
          <p className="2xl:text-3xl text-xl text-slate-800 leading-relaxed">
