export default function Navigation(props) {
  return (
    <header className="grid grid-cols-12 pt-8 sm:py-8 lg:mb-16 px-8 text-l m-auto z-30 relative max-w-screen-lg">
      ...
      <div className="col-start-7 col-span-6 justify-end lg:col-start-10 lg:col-span-3 flex flex-row lg:flex-col gap-2 leading-tight ">
        <div className="navigation--link">
          ...
          >
            ...
            <span className="lg:block hidden dark:text-gray-100 text-gray-800">
              hello
